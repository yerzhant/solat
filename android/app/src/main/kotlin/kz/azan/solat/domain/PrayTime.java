package kz.azan.solat.domain;//--------------------- Copyright Block ----------------------
/*
...
public class PrayTime {
    ...
    public static void main(String[] args) {
        double latitude = 43.238293;
        double longitude = 76.945465;
        double timezone = 6;
...
//        prayers.setTimeFormat(prayers.Time12);
        ...
        int[] offsets = {0, -3, 3, 3, 0, 3, 0}; // {Fajr,Sunrise,Dhuhr,Asr,Sunset,Maghrib,Isha}
